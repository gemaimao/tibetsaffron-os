...
<div class="evidence-line"><div><strong>品质与实证，应当有据可循。</strong><p>15 项国家级检验报告、海关出境检疫、劲酒全球37选1指纹图谱基准与党媒纪实，放在一起阅读。</p></div>${link('/site/brand/evidence.html','打开品质证据档案')}</div></div></section>
</main>${foot}${end}`;
