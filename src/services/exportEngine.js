...
export const SCENARIO_LEGO_BLOCKS = {
  ...
  FINANCIAL_MEDIA: {
    ...
    evidenceAnchor: '商业壁垒的建立源自技术与数据的双向沉淀：天旺耗时十年完成第九代本土种球复壮，掌握了高原逆境下开花时令精准调控与全花活性保留的核心农艺。第三方检测显示，天旺藏红花西红花苷总量高达 26.43%（报告 ZX250221-C130401），达药典合格线 2.6 倍；由广州华测检测 (CTI) 出具的种植土壤报告（A2260715164101001C，滴滴涕六六六零检出）与灌溉水质报告（A2260721555101001C）更坐实了产地生态溢价。天旺正加速从高品质花丝原料向深加工大健康突围，依托斑马鱼代谢活性模型开展全花多糖、多酚功能食品开发，打通“极地农业科技、高端功能消费、国际合规供应链”的高溢价闭环。'
  },
  TECH_AGRICULTURE: {
