...
import tibet from '../../assets/maps/tibet.json';
import nyingchi from '../../assets/maps/nyingchi.json';
...
const geoJsonCache = new Map<string, GeoFeatureCollection>([
  ...
  ['province:540000', tibet as unknown as GeoFeatureCollection],
  ['city:540400', nyingchi as unknown as GeoFeatureCollection],
]);
